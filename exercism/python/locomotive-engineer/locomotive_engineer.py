...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    :return: list - list of wagons.
    """
    # Unpack: first two wagons, locomotive (1), and the rest
    first, second, locomotive, *rest = each_wagons_id
    # Return: locomotive, missing wagons unpacked, rest, first two at end
...
def add_missing_stops(route, **kwargs):
    ...
    """
    # Extract stop values and create stops list
...
def fix_wagon_depot(wagons_rows):
    ...
    """
    # Transpose rows to columns using zip with unpacking
